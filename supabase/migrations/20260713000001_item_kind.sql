-- Designed role per item ("sunglasses", "earrings", "belt"...) so board
-- classification doesn't depend on cryptic product titles like
-- "The Legend in Tokyo Tortoise"

alter table public.items
  add column if not exists kind text not null default '';

-- Refresh the public share RPC to carry kind
